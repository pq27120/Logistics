...
public class DaoMaster extends AbstractDaoMaster {
    ...
    public static void createAllTables(SQLiteDatabase db, boolean ifNotExists) {
        LogisticsUserDao.createTable(db, ifNotExists);
        ...
        OperatorLogDao.createTable(db, ifNotExists);
        ErrOperatorLogDao.createTable(db, ifNotExists);
    }
    
    /** Drops underlying database table using DAOs. */
    public static void dropAllTables(SQLiteDatabase db, boolean ifExists) {
        LogisticsUserDao.dropTable(db, ifExists);
        ...
        OperatorLogDao.dropTable(db, ifExists);
        ErrOperatorLogDao.dropTable(db, ifExists);
    }
    ...
    public DaoMaster(SQLiteDatabase db) {
        ...
        registerDaoClass(LogisticsUserDao.class);
        ...
        registerDaoClass(OperatorLogDao.class);
        registerDaoClass(ErrOperatorLogDao.class);
    }
